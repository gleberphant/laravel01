    ...
    <div class="hero">
        <div class="main-wrapper">
            <div class="hero__content">
                <h1 class="display-large">CJ2 </h1>
                <a class="button button_sublte button_large" href="javascript:;" role="button">Escritórios Compartilhados </a>
            </div>
